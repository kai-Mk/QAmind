...
- 選択問題で間違えた回答はwrong-answers.jsonに記録される
- メインメニューから「間違えた問題を復習する」で再出題できる
...
### 間違えた選択問題: `wrong-answers.json`

選択問題で間違えた回答を記録する。
メインメニューの「間違えた問題を復習する」から再出題に使用する。

- practiceごとに間違えた問題を配列で保持する
- 問題文、選択した回答、正解、回答日時を記録する
